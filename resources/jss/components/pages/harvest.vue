      ...
      <div class="content-wrapper">
        <div class="container-fluid">
            <div class="row shadow-sm p-1 mb-1 bg-white rounded">
              <div class="col-md-2">Harvests</div>
            </div>
        </div>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr v-for="(item,index) in data" v-bind:key="index" class="trstyle">
                        ...
                        <td>{{item.harvest_quantity==null?0:item.harvest_quantity}} Kg</td>
                      </tr>
                    </tbody>
                  </table>
        ...
        loadData()
       {
         this.loading=true;
            let headers={
             ...
             axios.get(`/api/adminHarvestReport/${this.selectedOption}`,{
               headers:{
                'Accept':'application/json',
                'Authorization':'Bearer '+this.$store.state.user.token
               }
